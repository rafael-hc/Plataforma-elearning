...
export type CrateSubscriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CrateSubscriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CrateSubscriberDocument = gql`
    mutation CrateSubscriber($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CrateSubscriberMutationFn = Apollo.MutationFunction<CrateSubscriberMutation, CrateSubscriberMutationVariables>;

/**
 * __useCrateSubscriberMutation__
 *
 * To run a mutation, you first call `useCrateSubscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCrateSubscriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [crateSubscriberMutation, { data, loading, error }] = useCrateSubscriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCrateSubscriberMutation(baseOptions?: Apollo.MutationHookOptions<CrateSubscriberMutation, CrateSubscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CrateSubscriberMutation, CrateSubscriberMutationVariables>(CrateSubscriberDocument, options);
      }
export type CrateSubscriberMutationHookResult = ReturnType<typeof useCrateSubscriberMutation>;
export type CrateSubscriberMutationResult = Apollo.MutationResult<CrateSubscriberMutation>;
export type CrateSubscriberMutationOptions = Apollo.BaseMutationOptions<CrateSubscriberMutation, CrateSubscriberMutationVariables>;
